...
if __name__ == "__main__":
    ...
    dummy_test_users = [f"U{i:04d}" for i in range(1, 201)]
    report_path = r"c:\Users\Guruchandar\Downloads\insiEDR project\InsiEDR\latest_data\comparison_report.md"
    evaluate_new_run(top_users_csv, dummy_test_users, report_path)
