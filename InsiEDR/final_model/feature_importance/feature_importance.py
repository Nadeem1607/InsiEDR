...
latest_data_dir = os.path.join(project_root, "InsiEDR-G-model-latest-dataset", "latest_data")
features_csv_path = os.path.join(latest_data_dir, "if_enriched_features.csv")
labels_csv_path = os.path.join(project_root, "InsiEDR-G-model-latest-dataset", "OUTPUT_LABELS", "insider_labels.csv")
